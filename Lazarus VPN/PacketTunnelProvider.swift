...
class PacketTunnelProvider: NEPacketTunnelProvider {
	...
	override func startTunnel(options: [String : NSObject]?, completionHandler: @escaping (Error?) -> Void) {
        ...
        let obfuscater = ShadowsocksAdapter.ProtocolObfuscater.HTTPProtocolObfuscater.Factory(hosts:["ocsp.apple.com", "appldnld.apple.com", "radarsubmissions.apple.com", "iphonesubmissions.apple.com"], customHeader:nil)
